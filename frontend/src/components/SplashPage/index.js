    ...
    <div className="splash-page-container">
      ...
      <div className="splash-page-content">
        <div className="page-left">
          ...
          <p className="page-description">
            ...
            time and 100% fake money. If you're looking for a fake way to make friends
            and have fun, look no further! Fake your next group event here!
          </p>
        </div>
      ...
      <div className="feature-buttons">
        <NavLink className="link" to='/events'>
          ...
          <button className="link-text">
            Make new friends
            <img alt='arrow' className="arrow-guy" src='https://secure.meetupstatic.com/next/images/shared/right-arrow.svg?w=48'/>
          </button>
        </NavLink>
        <NavLink className="link" to='/events'>
      ...
      <div className="how-it-works">
        ...
        <p className="how-text">
          Meet fake people who share your fake intrests through
          online and in-person events. It's free to create an account.
        </p>
        <div className="join-find-start">
          <div className="start-links">
            <img className="start-link-img" alt='join a group' src='https://secure.meetupstatic.com/next/images/shared/handsUp.svg?w=384'/>
            <NavLink to='/groups'>
              <button className="start-link-btn">
                Join a group
              </button>
            </NavLink>
            <p className="start-link-text">
              Do what you love, meet fake others who love it,
              find your fake community. The rest is history!
            </p>
          </div>
          <div className="start-links">
            <img className="start-link-img" alt='find an event' src='	https://secure.meetupstatic.com/next/images/shared/ticket.svg?w=384' />
            <NavLink to='/events'>
              <button className="start-link-btn">
                Find an event
              </button>
            ...
            <p className="start-link-text">
              Fake events are happening on just about any topic
              you can think of, from online gaming and photography
              to yoga and hiking.
            </p>
          </div>
          <div className="start-links">
            <img className="start-link-img" alt='start a group' src='https://secure.meetupstatic.com/next/images/shared/joinGroup.svg?w=384' />
            ...
            <p className="start-link-text">
              You don't have to be an expert to gather fake people together
              and explore non-existent interests.
            </p>
          </div>
        </div>
      </div>
      <div className="join-div">
        <p className="join-btn"><OpenModalButton
